...
def Write_txt_without_header(rows):
    ...
    with open("PS_FBB_GL_CAUTO.txt", 'w') as file:
...
def process_files():
    ...
    path = "PS_FBB_GL_CAUTO.txt"  #PS_CAUTO_Accrual__BW191108.txt"  #PS_401Bill_GL_CAUTO.txt"   #C:\IS_Pyrl_Trsy_Files\\"+files[number]
    cobj = _TXTOBJ(path,"|")
